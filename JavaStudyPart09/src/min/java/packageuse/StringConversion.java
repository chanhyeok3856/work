...
public class StringConversion {
	public static void main(String[] args) {
		...
		// 문자열의 a 문자를 c 문자로 변경하고 출력한다.
		System.out.println("1. 문자열의 문자 변경 : " + str.replace('a', 'c'));
		// 문자열에서 공백을 빈 문자열로 변경하여 모든 공백을 제거하고 출력한다.
